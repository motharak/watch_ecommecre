...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Jewelry Store @yield('pageTitle')</title>
				            ...
				            <div class="attr-nav">
				                <ul>
				                	...
				                	<li class="nav-setting">
				                		<a href="#"><span class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
					...
					<div class="row">
						...
						<div class=" col-md-3 col-sm-6 col-xs-12">
							<div class="hm-footer-widget">
								...
								<div class="hm-foot-menu">
									<ul>
										<li><a href="#">Women Watch</a></li><!--/li-->
										<li><a href="#">Men Watch</a></li><!--/li-->
